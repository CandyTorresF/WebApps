<?php
    ...
    if($conn -> connect_error){
        ...
        $uName = $_POST["uUsuarioIngreso"];
        $uPassword = $_POST["uContrasenaIngreso"];
    ...
    if($conn -> connect_error){
        ...
        $uUsuarioIngreso = $_POST["uUsuarioIngreso"];
        $uContrasenaIngreso = $_POST["uContrasenaIngreso"];
        #echo $uUsuarioIngreso;
        #echo $uContrasenaIngreso;
        $sql = "SELECT firstName, lastName
                FROM Usuarios
                WHERE username = '$uUsuarioIngreso'AND accesskey = '$uContrasenaIngreso'";
        #echo $sql;
        $result = $conn -> query($sql);
        ...
        if ($remember == "true")
        {
            setcookie("username", $uUsuarioIngreso, time() + 3600*24*20);
            setcookie("passwrd", $uContrasenaIngreso, time() + 3600*24*20);
        }
        ...
        if($result -> num_rows > 0){
            ...
            // Abrir y guardar datos en la sesión
            session_start();
